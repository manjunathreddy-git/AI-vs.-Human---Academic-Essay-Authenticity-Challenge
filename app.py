...
#             if perplexity > 15000 and burstiness_score < 0.4:
...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            st.warning("Disclaimer: AI vs Human detector apps can assist in identifying whether text was generated by AI or written by a human; however, their results may not be entirely flawless or completely reliable. These tools use advanced algorithms but can still produce false positives or false negatives. Therefore, human judgment and manual verification are recommended to ensure accurate and comprehensive results.")
...
# # Add a "Back" button to go back to the Flask app
# if st.button("Back to Home"):
#     js = """
#     <script type="text/javascript">
#         window.location.href = 'http://127.0.0.1:5000/userviewprofile';
#     </script>
#     """
